    ...
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="card mb-6">
            ...
            <div className="flex flex-wrap items-center gap-3 text-sm text-gray-400">
              ...
              {org.founded_year && (
                <span className="flex items-center gap-1">
                  ...
                  {i18n.language === 'bg' ? "Рег. " : "Est. "} {org.founded_year}
                </span>
              )}
              <span className="flex items-center gap-1">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {members} {i18n.language === 'bg' ? "членове" : "member"}{(i18n.language === 'en' && members !== 0) ? 's' : ''}
              </span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-3 gap-4 mt-5 pt-5 border-t border-gray-100">
          {[
            { label: t('common.activeprojects'), value: projects.length },
            { label: t('common.activeevnents'), value: events.length },
            { label: t('common.teammembers'), value: members },
          ].map(s => (
      ...
      {tab === 'about' && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-2 flex flex-col gap-6">
            ...
            {description && (
              <div className="card">
                <h2 className="text-base font-medium text-gray-900 mb-3">{t('nav.about')}</h2>
            ...
            {(org.facebook_url || org.instagram_url || org.linkedin_url) && (
              <div className="card">
                <h2 className="text-base font-medium text-gray-900 mb-3">{t('common.followus')}</h2>
          ...
          <div className="flex flex-col gap-4">
            <div className="card">
              <h2 className="text-base font-medium text-gray-900 mb-3">{t('common.details')}</h2>
              <div>
