          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <input type="text" className="input" placeholder="Maria Kostadinova"
                ...
                {L.full_name} <span className="text-red-400">{L.required}
            ...
            <div>
              ...
              <input type="text" className="input" placeholder="Мария Костадинова"
                ...
                onChange={e => { set('full_name_bg', e.target.value); setFullNameBGError(validateFullName(e.target.value, lang)) }} />
                {fullnameBGError && <p className="text-xs text-red-500 mt-1">{fullnameBGError}</p>}
            </div>
          </div>
